...
import { customAutocompleteInputProps } from "./types";
import { styles } from "./CustomAutocompleteInput.styled";
...
import { FILTER_START, MAX_OPTIONS, OPTIONS } from "./constants";
import { colors } from "config/styles/themeColors";

export const CustomAutocompleteInput: React.FC<
...
> = ({
  ...
  return (
    ...
    >
      <Grid item md={5.5} xs={12} sx={styles.contentItem}>
